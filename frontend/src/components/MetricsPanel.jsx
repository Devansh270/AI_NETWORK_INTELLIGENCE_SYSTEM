  ...
  return (
    <div className="bg-gray-800 rounded-xl p-5">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-white font-medium text-sm">Packets / second</h2>
        <span className="text-gray-400 text-xs">Rolling 60 s</span>
      </div>
      <ResponsiveContainer width="100%" height={220}>
        <LineChart data={dataPoints} margin={{ top: 4, right: 12, bottom: 0, left: -8 }}>
